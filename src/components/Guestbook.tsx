...
const mockMessages = [
  { id: 1, name: "ABC", content: "Test 01 <3" },
  {
    ...
    name: "Dũng Suneo",
    content:
      "Thay cho lời chúc sến súa, ta chúc hạnh phúc nhesss :)))) chúc mừng hạnh phúc!!!",
  },
  {
    id: 3,
    name: "Tun",
    content: "Chúc mừng Hương đã tìm được bạn đời của mình 🥰",
  },
  { id: 4, name: "Tân", content: "Đẹp đôi quá a. Chúc anh chị hạnh phúc nha" },
  {
    id: 5,
    name: "Chi Nhi",
    content: "Chúc hai bạn trăm năm hạnh phúc, luôn vui vẻ và yêu thương nhau!",
  },
  {
    id: 6,
    name: "Anonymous",
  ...
  },
  {
    ...
    name: "Minh Anh",
    content:
      "Chúc hai bạn xây dựng được một tổ ấm thật hạnh phúc và tràn ngập tiếng cười!",
  },
  {
    id: 8,
    name: "Hoàng Nam",
    content: "Best wishes for a lifetime of love and happiness!",
  },
  {
    id: 9,
    name: "Thu Hà",
    content:
      "Chúc mừng hai bạn! Mong rằng tình yêu của hai bạn sẽ ngày càng bền chặt.",
  },
  {
    id: 10,
    name: "Kim Oanh",
    content:
      "Chúc hai bạn luôn hạnh phúc và gặp nhiều may mắn trên con đường phía trước!",
  },
];
          ...
          <div className="border-2 border-rose-200 rounded-lg p-8">
            ...
            <div className="mt-8 space-y-6">
              {messages.map((message) => (
                <div
                  key={message.id}
                  className="border-b border-rose-100 pb-4 last:border-0"
                >
